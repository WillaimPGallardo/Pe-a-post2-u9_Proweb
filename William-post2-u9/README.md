...
Cada prueba está documentada con su captura correspondiente en la carpeta
`capturas/`.
...
→ Captura: `capturas/01_preauthorize_403_personalizada.png`
...
→ Captura: `capturas/02_xss_dashboard.png`
...
→ Captura: `capturas/03_xss_html_inspeccionado.png`
...
→ Captura: `capturas/04_csp_header_devtools.png`
...
→ Captura: `capturas/05_csrf_curl_rechazado.png`
