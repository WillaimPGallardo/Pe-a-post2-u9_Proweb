...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // Habilita @PreAuthorize a nivel de metodo
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            // Pagina personalizada para acceso denegado (Post 2 - Paso 2)
            .exceptionHandling(ex -> ex
                .accessDeniedPage("/error/403")
            )
            // Cabecera Content-Security-Policy (Post 2 - Paso 4)
